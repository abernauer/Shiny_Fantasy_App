...
Shane_Beliebers_players <- c(SS[12], second[11], second[12], center_field[8], center_field[9], center_field[10],   starting_pitcher[31], starting_pitcher[32], starting_pitcher[33], first[14], second[13], catcher[8], first[15], SS[13], third[10], starting_pitcher[34], starting_pitcher[35], relief_pitcher[14], relief_pitcher[15])
...
A_Rod_picks <- pick_2[134:152]

A_Rod_bids <- bids[134:152]

Sniffers_Row_picks <- pick_2[153:171]

Sniffers_Row_bids <- bids[153:171]

Team_Christy_picks <- pick_2[172:190]

Team_Christy_bids <- bids[172:190]

Long_Ball_picks <- pick_2[191:209]


Long_Ball_bids <- bids[191:209]

The_Wright_picks <- pick_2[210:228]
